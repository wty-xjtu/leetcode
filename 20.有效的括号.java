...
class Solution {
    ...
    // 那么字符串 ss 无效，返回\text{False}False。为了快速判断括号的类型，我们可以使用哈希表存储每一种括号。哈希表的键为右括号，值为相同类型的左括号。
    // 在遍历结束后，如果栈中没有左括号，
    // 说明我们将字符串 ss 中的所有左括号闭合，返回\text{True}True，否则返回\text{False}False。
    ...
    public boolean isValid(String s) {
        ...
        return geshu == 0;// 若左括号数和右括号数相同则返回true，否则返回false
    }
}
// @lc code=end
